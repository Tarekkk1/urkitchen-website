...
import PhonePePayment from "../PaymentMethods/PhonePePayment";
import PaymobPayment from "../PaymentMethods/PaymobPayment";
import InstapayPayment from "../PaymentMethods/InstapayPayment";
...
const PaymentModal = ({
  ...
  finalTotal,
  scheduleData = { scheduled_time: "", scheduled_to_time: "", is_same_day: 0 },
}) => {
      ...
      <ModalContent className="md:max-h-none md:overflow-visible max-h-[90vh] overflow-y-auto">
        ...
        {selectedPayment === "instapay" && (
          <InstapayPayment
            ...
            is_self_pick_up={is_self_pick_up}
            onClose={onClose}
            paymentMethodDetails={availablePaymentMethods.find((m) => m.id === "instapay")}
            type="placeOrder"
            isWalletUsed={useWallet}
            walletAmountUsed={useWallet ? (isWalletSufficient ? finalTotal : walletBalance) : 0}
        ...
        {selectedPayment !== "instapay" && selectedPayment !== "paymob" && (
