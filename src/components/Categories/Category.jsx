    ...
    <div className="relative">
      <div className="relative flex items-center justify-between w-full px-0 py-2">
        ...
        <div className="flex flex-row gap-2">
          <button
            className={`transition text-white rounded-full p-1 sm:p-2 shadow
              ${isBeginning ? "bg-gray-300 cursor-not-allowed" : "bg-primary hover:bg-primary/80"}`}
            onClick={handlePrev}
          ...
          <button
            className={`transition text-white rounded-full p-1 sm:p-2 shadow
              ${isEnd ? "bg-gray-300 cursor-not-allowed" : "bg-primary hover:bg-primary/80"}`}
            onClick={handleNext}
            disabled={isEnd}
          >
