...
import { RestaurantJsonLd, WebSiteJsonLd } from "@/components/JsonLd/JsonLd";
...
const HomePage = () => {
  ...
  const webSettings = useSelector((state) => state.settings?.value?.web_settings?.[0]);
  ...
  return (
    <>
      <HeadTitle
        title={t("home")}
        description="اطلب طعامك المفضل أونلاين من urkitchen — توصيل سريع في مصر. Order your favourite food online from urkitchen — fast delivery across Egypt."
        keywords="food delivery egypt, order food online cairo, urkitchen, مطعم توصيل, طلب طعام اونلاين, القاهرة, مصر"
      />
      <RestaurantJsonLd settings={webSettings} />
      <WebSiteJsonLd siteName="urkitchen" />
      <div className="mt-6">
      ...
      {homeStoreData.popularSections?.length > 0 && (
        <div className="mt-6">
          <PopularSection
